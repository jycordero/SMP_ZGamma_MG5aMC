void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(13,0.0071252298956);
  S7_ETA_0->SetBinContent(14,0.0866902887298);
  S7_ETA_0->SetBinContent(15,0.136171098005);
  S7_ETA_0->SetBinContent(16,0.207819196955);
  S7_ETA_0->SetBinContent(17,0.293321995702);
  S7_ETA_0->SetBinContent(18,0.366553494629);
  S7_ETA_0->SetBinContent(19,0.437409893591);
  S7_ETA_0->SetBinContent(20,0.454431293342);
  S7_ETA_0->SetBinContent(21,0.474223593052);
  S7_ETA_0->SetBinContent(22,0.425138693771);
  S7_ETA_0->SetBinContent(23,0.354678094803);
  S7_ETA_0->SetBinContent(24,0.267591996079);
  S7_ETA_0->SetBinContent(25,0.208610896943);
  S7_ETA_0->SetBinContent(26,0.146463097854);
  S7_ETA_0->SetBinContent(27,0.0839193687704);
  S7_ETA_0->SetBinContent(28,0.0083127678782);
