...
Decay_Z = Decay(name = 'Decay_Z',
                particle = P.Z,
                partial_widths = {(P.a,P.a):'(MZ**2*(-(CBBL4**2*cw**4*ee**2*MZ**6*vev**4)/2.e23 - (CBtWL4**2*cw**4*ee**2*MZ**6*vev**4)/1.e24 - (CBWL4**2*cw**4*ee**2*MZ**6*vev**4)/1.6e24 - (CBBL4*cw**4*CWWL4*ee**2*MZ**6*vev**4)/8.e23 - (CBBL4**2*cw**6*ee**2*MZ**6*vev**4)/(4.e23*sw**2) + (CBBL4*CBWL4*cw**5*ee**2*MZ**6*vev**4)/(4.e23*sw) + (CBBL4*CBWL4*cw**3*ee**2*MZ**6*sw*vev**4)/2.e23 + (CBWL4*cw**3*CWWL4*ee**2*MZ**6*sw*vev**4)/1.6e24 - (CBBL4**2*cw**2*ee**2*MZ**6*sw**2*vev**4)/4.e23 - (CBtWL4**2*cw**2*ee**2*MZ**6*sw**2*vev**4)/5.e23 - (CBWL4**2*cw**2*ee**2*MZ**6*sw**2*vev**4)/8.e23 - (CBBL4*cw**2*CWWL4*ee**2*MZ**6*sw**2*vev**4)/4.e23 - (cw**2*CWWL4**2*ee**2*MZ**6*sw**2*vev**4)/6.4e24 + (CBBL4*CBWL4*cw*ee**2*MZ**6*sw**3*vev**4)/4.e23 + (CBWL4*cw*CWWL4*ee**2*MZ**6*sw**3*vev**4)/8.e23 - (CBtWL4**2*ee**2*MZ**6*sw**4*vev**4)/1.e24 - (CBWL4**2*ee**2*MZ**6*sw**4*vev**4)/1.6e24 - (CBBL4*CWWL4*ee**2*MZ**6*sw**4*vev**4)/8.e23 - (CWWL4**2*ee**2*MZ**6*sw**4*vev**4)/3.2e24 + (CBWL4*CWWL4*ee**2*MZ**6*sw**5*vev**4)/(1.6e24*cw) - (CWWL4**2*ee**2*MZ**6*sw**6*vev**4)/(6.4e24*cw**2)))/(96.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.W__minus__,P.W__plus__):'(((-12*cw**2*ee**2*MW**2)/sw**2 - (17*cw**2*ee**2*MZ**2)/sw**2 + (4*cw**2*ee**2*MZ**4)/(MW**2*sw**2) + (cw**2*ee**2*MZ**6)/(4.*MW**4*sw**2) - (CWWL4**2*ee**2*MW**4*MZ**2*vev**4)/2.e24 + (CBtWL4**2*ee**2*MW**2*MZ**4*vev**4)/2.5e23 + (9*CWWL4**2*ee**2*MW**2*MZ**4*vev**4)/8.e24 - (CBtWL4**2*ee**2*MZ**6*vev**4)/5.e23 - (CBWL4**2*ee**2*MZ**6*vev**4)/4.e24 - (3*CWWL4**2*ee**2*MZ**6*vev**4)/4.e24 + (CBtWL4**2*ee**2*MZ**8*vev**4)/(4.e24*MW**2) + (CBWL4**2*ee**2*MZ**8*vev**4)/(1.6e25*MW**2) + (CWWL4**2*ee**2*MZ**8*vev**4)/(8.e24*MW**2) - (cw**2*CWWL4**2*ee**2*MW**4*MZ**2*vev**4)/(4.e24*sw**2) + (9*cw**2*CWWL4**2*ee**2*MW**2*MZ**4*vev**4)/(1.6e25*sw**2) - (3*cw**2*CWWL4**2*ee**2*MZ**6*vev**4)/(8.e24*sw**2) + (cw**2*CWWL4**2*ee**2*MZ**8*vev**4)/(1.6e25*MW**2*sw**2) - (CBWL4*cw*CWWL4*ee**2*MW**2*MZ**4*vev**4)/(2.e24*sw) + (CBWL4*cw*CWWL4*ee**2*MZ**6*vev**4)/(1.6e24*sw) - (CBWL4*cw*CWWL4*ee**2*MZ**8*vev**4)/(8.e24*MW**2*sw) - (CBWL4*CWWL4*ee**2*MW**2*MZ**4*sw*vev**4)/(2.e24*cw) + (CBWL4*CWWL4*ee**2*MZ**6*sw*vev**4)/(1.6e24*cw) - (CBWL4*CWWL4*ee**2*MZ**8*sw*vev**4)/(8.e24*cw*MW**2) - (CWWL4**2*ee**2*MW**4*MZ**2*sw**2*vev**4)/(4.e24*cw**2) + (9*CWWL4**2*ee**2*MW**2*MZ**4*sw**2*vev**4)/(1.6e25*cw**2) - (3*CWWL4**2*ee**2*MZ**6*sw**2*vev**4)/(8.e24*cw**2) + (CWWL4**2*ee**2*MZ**8*sw**2*vev**4)/(1.6e25*cw**2*MW**2))*cmath.sqrt(-4*MW**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)'})
