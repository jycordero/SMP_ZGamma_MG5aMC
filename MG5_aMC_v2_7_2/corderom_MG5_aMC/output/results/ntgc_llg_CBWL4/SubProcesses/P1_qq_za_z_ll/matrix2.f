...
C     
C     Process: d d~ > z a NP<=1 WEIGHTED<=3 @1
C     *   Decay: z > e- e+ NP<=1 WEIGHTED<=2
C     Process: s s~ > z a NP<=1 WEIGHTED<=3 @1
C     *   Decay: z > e- e+ NP<=1 WEIGHTED<=2
C     Process: d d~ > z a NP<=1 WEIGHTED<=3 @1
C     *   Decay: z > mu- mu+ NP<=1 WEIGHTED<=2
C     Process: s s~ > z a NP<=1 WEIGHTED<=3 @1
C     *   Decay: z > mu- mu+ NP<=1 WEIGHTED<=2
C     
      USE DISCRETESAMPLER
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV2_3_3(W(1,4),W(1,3),GC_21,GC_18,MDL_MZ, FK_MDL_WZ,W(1,5))
      CALL VXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,4))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVV10_11_0(W(1,4),W(1,3),W(1,5),GC_51,GC_48,AMP(1))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_19,GC_16,MDL_MZ, FK_MDL_WZ,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL VVV1_4_5_6_0(W(1,4),W(1,5),W(1,3),GC_39,GC_50,GC_41,GC_40
     $ ,AMP(2))
