...
V_3 = Vertex(name = 'V_3',
             ...
             couplings = {(0,0):C.GC_33,(0,1):C.GC_44})

V_4 = Vertex(name = 'V_4',
             particles = [ P.a, P.W__minus__, P.G__plus__ ],
             color = [ '1' ],
             lorentz = [ L.VVS4, L.VVS7 ],
...
V_6 = Vertex(name = 'V_6',
             ...
             color = [ '1' ],
             lorentz = [ L.VVV1, L.VVV4, L.VVV7 ],
             couplings = {(0,0):C.GC_37,(0,1):C.GC_38,(0,2):C.GC_4})
...
V_9 = Vertex(name = 'V_9',
             ...
             color = [ '1' ],
             lorentz = [ L.VVS1, L.VVS4, L.VVS7 ],
             couplings = {(0,0):C.GC_34,(0,1):C.GC_26,(0,2):C.GC_43})

V_10 = Vertex(name = 'V_10',
              particles = [ P.W__minus__, P.Z, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVS2, L.VVS7 ],
              couplings = {(0,0):C.GC_30,(0,1):C.GC_31})

V_11 = Vertex(name = 'V_11',
              particles = [ P.W__minus__, P.W__plus__, P.Z ],
              color = [ '1' ],
              lorentz = [ L.VVV10, L.VVV2, L.VVV7, L.VVV8 ],
              couplings = {(0,1):C.GC_35,(0,3):C.GC_36,(0,0):C.GC_46,(0,2):C.GC_14})
...
V_13 = Vertex(name = 'V_13',
              ...
              color = [ '1' ],
              lorentz = [ L.VVV10, L.VVV11 ],
              couplings = {(0,1):C.GC_48,(0,0):C.GC_51})

V_14 = Vertex(name = 'V_14',
              particles = [ P.a, P.Z, P.Z ],
              color = [ '1' ],
              lorentz = [ L.VVV1, L.VVV4, L.VVV5, L.VVV6 ],
              couplings = {(0,3):C.GC_40,(0,2):C.GC_41,(0,0):C.GC_39,(0,1):C.GC_50})

V_15 = Vertex(name = 'V_15',
              particles = [ P.Z, P.Z, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.VVS3, L.VVS7 ],
              couplings = {(0,0):C.GC_32,(0,1):C.GC_42})

V_16 = Vertex(name = 'V_16',
              particles = [ P.Z, P.Z, P.Z ],
              color = [ '1' ],
              lorentz = [ L.VVV3, L.VVV9 ],
