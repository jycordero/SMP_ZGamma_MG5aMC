...
C     
C     Process: d d~ > z a WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QCD<=2 QED<=2
C     Process: s s~ > z a WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QCD<=2 QED<=2
C     Process: d d~ > z a WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QCD<=2 QED<=2
C     Process: s s~ > z a WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QCD<=2 QED<=2
C     
      USE DISCRETESAMPLER
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV2_4_3(W(1,4),W(1,3),-GC_51,GC_59,MDL_MZ, FK_MDL_WZ,W(1,5)
     $ )
      CALL VXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,4))
      CALL FFV2_3_2(W(1,1),W(1,5),-GC_51,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,3),W(1,2),W(1,4),GC_1,AMP(1))
      CALL FFV1_2(W(1,1),W(1,4),GC_1,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,5),-GC_51,GC_58,AMP(2))
