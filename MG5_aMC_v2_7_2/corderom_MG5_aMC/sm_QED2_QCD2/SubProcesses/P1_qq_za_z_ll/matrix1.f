...
C     
C     Process: u u~ > z a WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QCD<=2 QED<=2
C     Process: c c~ > z a WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QCD<=2 QED<=2
C     Process: u u~ > z a WEIGHTED<=4 @1
...
C     ----------
     ...
     $ )
      ...
      CALL FFV2_5_2(W(1,1),W(1,5),GC_51,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,3),W(1,2),W(1,4),GC_2,AMP(1))
      CALL FFV1_2(W(1,1),W(1,4),GC_2,ZERO, FK_ZERO,W(1,3))
