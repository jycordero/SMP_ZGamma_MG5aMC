...
MAOUT=/home/jcordero/CMS/Theory/MG5_aMC_v2_7_2/corderom/output/results/ntgc_llg_$COUPLING/MA5_PARTON_ANALYSIS_analysis1
if [ -d $MAOUT ]; then
	rm -r $MAOUT
fi
...
echo "submit $MAOUT" >> $OUTDIR/$OUTFILE
echo "exit" >> $OUTDIR/$OUTFILE
echo "exit" >> $OUTDIR/$OUTFILE
echo "exit" >> $OUTDIR/$OUTFILE
